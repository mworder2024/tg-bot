...
bot.command('help', (ctx) => {
  ...
  if (isAdmin) {
    message += '👑 **ADMIN INFO:**\n';
    message += 'As an admin, you have access to:\n';
    message += '• Group management controls\n';
    message += '• Game administration\n';
    message += '• Bot statistics\n';
    message += '• Prize management\n\n';
    message += 'Access admin panel via `/admin` or `/start`\n\n';
  }
...
async function startGame(chatId: string) {
  ...
  // Auto-select random numbers for all players
