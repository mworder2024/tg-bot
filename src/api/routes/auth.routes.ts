...
This signature will not trigger any blockchain transaction or cost any gas fees.`;
  ...
  router.post('/login',
    ...
    asyncHandler(async (req: Request, res: Response) => {
      ...
      const token = jwt.sign(tokenPayload, jwtSecret, { expiresIn: jwtExpiresIn } as jwt.SignOptions);
  ...
  router.post('/refresh',
    ...
    asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
      ...
      const newToken = jwt.sign(tokenPayload, jwtSecret, { expiresIn: jwtExpiresIn } as jwt.SignOptions);
